                ...
                <div class="questions__list_element_btn">
                    <?php if($question->status == 2){?>
                        ...
                        <?PHP IF($question->status==4):?>
                            <a href="/questions/myvoiting/view/<?=$question->id?>" class="btn_questions"><?=\Yii::t('app','More detailed')?></a>
                        <?PHP ELSEIF($question->status==5):?>
                            <a href="/questions/myvoiting/voting/<?=$question->id?>" class="btn_questions"><?=\Yii::t('app','More detailed')?></a>
                        <?PHP ELSEIF($question->status==6):?>
                            <a href="/questions/myvoiting/close/<?=$question->id?>#<?=$user->id?>" class="btn_questions"><?=\Yii::t('app','More detailed')?></a>
                        <?PHP ENDIF;?>
                    <?php
                        } else{
                    ?>
