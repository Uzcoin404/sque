  ...
  <div class="row page__row">
      <aside class="sidebar">
        ...
        <div class="filter">
          <div class="filter__input">
            ...
            <input type="text" name="filter" id="filter_locations_name" placeholder="Название локации">
          </div>
        </div>
          <div class="groups filter_locations_groups">
      ...
      <div class="col page__col">
        <div class="main">
          ...
          <div id="books_list_items" class="books_list locations">
