...
<div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel">Создание локации</h5>
                ...
                <div class="tab-pane fade active show" id="main_<?=$model->id;?>">
                    ...
                    <div class="container form-modal__container">
                        <div class="row form-modal__row">
                            <div class="col-12">        
                                <?= $form->field($model, 'name',['inputOptions' => ['id' => 'create-locations-name-'.$model->id]])->textArea(['class'=>'','maxlength' => true])->label() ?>
                            </div>       
                            <div class="col-12">  
                                <?= $form->field($model, 'description',['inputOptions' => ['id' => 'update-locations-description-'.$model->id]])->textArea(['class'=>'','maxlength' => true])->label() ?>
                            </div>      
                            <div class="col-12">
                                <?= $form->field($model, 'group',['inputOptions' => ['class'=>'','id' => 'create-model-id_group-'.$model->id]])->widget(Select2::classname(), [
                            ...
                            <div class="col-12 col-md-6">
                                        ...
                                        <a onclick="ClearBookLocationsImage(this);"  data-id="0"  class="btn form-modal__btn">
                                                <i class="bi bi-trash"></i> Очистить изображение
                                        </a>
                            </div>
                        </div>
                        <div class="form-modal__footer">
                                <a OnClick="SaveLocation('create_location',this);" class="btn form-modal__footer-btn">
                                  <i class="bi bi-save"></i>Сохранить
                                </a>
                                <button type="submit" class="btn form-modal__footer-btn">
                                  <i class="bi bi-box-arrow-in-left"></i>Сохранить и закрыть
                                </button>
                                <a OnClick="SaveLocationAndAdd('create_location',this);"  class="btn form-modal__footer-btn">
