    ...
    <?PHP IF($group["group"]->status):?>
        <div class="group-list">
            <div class="group-list__title">
                ...
                <div id="books_cols" class="accordion_row">
                    <div id="books_group-<?=$group["group"]->id;?>" class="row row-cols-2 row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 row-col-xl-5 group-list__row">
                        <?= 
