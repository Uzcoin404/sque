...
<div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel">Редактирование сцены: <?=$model->name;?></h5>
            ...
            <div class="tab-content">
                <div class="tab-pane fade active show" id="main_<?=$model->id;?>">
                    <?php $form = ActiveForm::begin(
                        [
                            'id' => 'update_book_scene',
                            'options' => [
                                'class' => 'form-modal'
                            ],
                            'action' => '/scenes/update/'.$model->id,
                    ...
                    <div class="tab-pane fade active show" id="add-main">
                        <div class="container form-modal__container">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <a onclick="ClearBookScenesImage(this);"  data-id="<?=$model->id;?>" class="btn form-modal__btn">
                            ...
                            <div class="form-modal__footer">
                                    <a OnClick="CreateScenesOnHide('update_book_scene',this);" class="btn form-modal__footer-btn">
                                    ...
                                    <a  OnClick="CreateScenesAndAdd('update_book_scene',this);" class="btn form-modal__footer-btn">
                                    <i class="bi bi-arrow-repeat"></i>Сохранить и добавить еще сцену
                                    </a>
                                    <a onclick="DeleteScenes(this,1);"  data-id="<?=$model->id;?>" class="btn form-modal__footer-btn">
