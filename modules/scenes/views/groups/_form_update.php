...
<div class="modal-content">
  ...
  <div class="modal-body">
         ...
         <?php $form = ActiveForm::begin(
           [
            'id' => 'update_book_scene_group',
            'options' => [
              'class' => 'form-modal'
            ],
            'action' => '/scenes/groups/update/'.$model->id,
           ]
         ); ?>
       <div class="container form-modal__container">
          <div class="row form-modal__row">
            <div class="col-12">
              <?= $form->field($model, 'name',['inputOptions' => ['id' => 'update-scenes-groups-name-'.$model->id]])->textInput(['maxlength' => true])->label() ?>
            </div>
            <div class="col-12">
              <?= $form->field($model, 'color',['inputOptions' => ['id' => 'update-scenes-groups-color-'.$model->id]])->widget(alexantr\colorpicker\ColorPicker::className()) ?>
            </div>
          </div>
