<?PHP
use app\modules\models\models\Bookmodels;
...
<div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel">Редактирование персонажа: <?=$model->name;?></h5>
...
<div class="tab-pane fade active show" id="add-main">
              <div class="container form-modal__container">
                <div class="row form-modal__row">
                  ...
                  <div class="col-12 col-md-4">
                    <?= $form->field($model, 'bod',['inputOptions' => ['id' => 'update-model-bod-']])->textInput(['class'=>'','maxlength' => true,'value'=>$model->bod])->label() ?>
                    
                  </div>
                  <div class="col-12 col-md-4">
                    <?= $form->field($model, 'dod',['inputOptions' => ['id' => 'update-model-dod-']])->textInput(['class'=>'','maxlength' => true,'value'=>$model->dod])->label() ?>
                  ...
                  <div id="parents_add" data-id="<?=$model->id;?>" class="col-12">
                    <div class="row">
                        <div class="col-12">
                  ...
                  <?PHP IF($model->image):?>
                        ...
                        <div class="col-12 col-md-6">
                          <?= $form->field($model, 'imageFile')->fileInput(['placeholder' => 'Изображение',
                            ...
                            <a onclick="ClearBookPersImage(this);"  data-id="<?=$model->id;?>" class="btn form-modal__btn">
          ...
          <div class="form-modal__footer">
                                <a OnClick="SavePers('update_pers',this);" class="btn form-modal__footer-btn">
                                  <i class="bi bi-save"></i>Сохранить
                                </a>
                                <button type="submit" class="btn form-modal__footer-btn">
                                  <i class="bi bi-box-arrow-in-left"></i>Сохранить и закрыть
                                </button>
                                <a OnClick="SavePersAndAdd('update_pers',this);" class="btn form-modal__footer-btn">
                                  <i class="bi bi-arrow-repeat"></i>Сохранить и добавить
                                </a>
                                <a onclick="DeletePers(this,1);"  data-id="<?=$model->id;?>" class="btn form-modal__footer-btn">
